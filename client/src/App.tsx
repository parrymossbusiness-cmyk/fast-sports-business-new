...
function BrandMark() {
  return <span className="brand-mark-wrap" aria-hidden="true"><img src="/manus-storage/fast-sports-mark_028c7436.png" alt="" /><span className="brand-mark"><span className="brand-mark__chevron" /><span className="brand-mark__pulse" /></span></span>;
}
    ...
    <main id="top">
      <section className="hero section-grid">
        ...
        <div className="hero-art" aria-label="Hero animation of two young athletes playing fast football">
          <video className="hero-video" autoPlay muted loop playsInline preload="metadata" poster="/manus-storage/fast-sports-hero_1cc0c75d.png"><source src="/manus-storage/fast-sports-business-hero-concept_20da8a02.mp4" type="video/mp4" /></video><div className="hero-video-shade" />
