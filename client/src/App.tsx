    ...
    <main id="top">
      <section className="hero hero--cinematic section-grid">
        ...
        <div className="hero-art" aria-label="Hero animation of two young athletes playing fast football">
          <video className="hero-video" autoPlay muted loop playsInline preload="metadata"><source src="/assets/fast-sports-business-hero-concept.mp4" type="video/mp4" /><source src="/manus-storage/fast-sports-business-hero-concept_20da8a02.mp4" type="video/mp4" /></video><div className="hero-video-shade" />
