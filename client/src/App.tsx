...
const faqs = [
  ["What is Fast Football Business?", "Fast Football Business is an independent daily intelligence publication for the marketers, sponsors, investors, and athletes shaping fast football and the dynamic sports economy around it."],
  ["How often is the newsletter published?", "The Daily Fast Football Intelligence Briefing is built around a one-article-per-day cadence: one sharp executive read, every day, with market context and a clear strategic takeaway."],
  ...
  ["How can brands, sponsors, and investors collaborate with Fast Football Business?", "Partners can collaborate through sponsorship strategy, custom intelligence briefings, executive events, editorial partnerships, and targeted advisory work with the Fast Football Business desk."],
  ["How does Fast Football Business spotlight 18–24 athletes?", "The publication tracks the 18–24 athlete cohort as a business signal: emerging audience behavior, media fluency, NIL structures, and the new pathways from performance to ownership."],
];
...
function Home() {
  ...
  return <div className="site-shell">
    <header className="site-header">
      <a className="brand-lockup" href="#top" onClick={(e) => { e.preventDefault(); scrollTo("#top"); }} aria-label="Fast Football Business home">
        <BrandMark /><span className="brand-wordmark"><strong>FAST FOOTBALL</strong><em>BUSINESS</em></span>
      </a>
    ...
    <footer className="site-footer"><div className="footer-top"><a className="brand-lockup" href="#top"><BrandMark /><span className="brand-wordmark"><strong>FAST FOOTBALL</strong><em>BUSINESS</em></span></a><div className="footer-statement"><span>THE BUSINESS INTELLIGENCE HUB</span><p>Making the next format legible.</p></div><div className="footer-news"><span>GET THE SIGNAL</span><form onSubmit={(e) => e.preventDefault()}><input type="email" required placeholder="Email address" aria-label="Email address" /><button aria-label="Subscribe"><ArrowUpRight size={16} /></button></form></div></div><div className="footer-bottom"><span>© 2028 FAST FOOTBALL BUSINESS</span><div><a href="#newsletter">RSS</a><a href="#newsletter">LinkedIn</a><a href="#newsletter">X</a></div><span>BUILT FOR THE NEXT PLAY <i>✳</i></span></div></footer>
  </div>;
}
